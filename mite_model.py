...
class Metapopulation:
    ...
    def __init__(self, 
                 ...
                 repeat_n):
        self.carrying_c = carrying_c   
        title  =  'Mite_range_model_cc_%s_disp_m_%s_rl_%s_mut_%s_dto_%s_rto_%s_rep_%s.out'
...
if __name__ == '__main__':                
    SIMULATION = Simulation(maxtime = 100002, 
                            ...
                            max_y = 100, 
                            max_season_time = 365, 
                            max_latitude_effect = 2.50506, #how much warmer it is in the extreme south compared to the extreme north
